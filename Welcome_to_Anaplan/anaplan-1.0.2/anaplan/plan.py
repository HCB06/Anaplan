...
def activations_list():
    """
    linear,: perfect for linearly seperable datasets
    spiral,: perfect for spiral dataset
    sigmoid,
    relu,
    tanh,: good for general tabular datasets
    swish,
    circular,
    mod_circular,
    tanh_circular,
    ...
    elu,
    gelu,: useful(some)
    selu,: good for general datasets(some)
    sinakt, 
    p_squared, 
    sglu, 
    dlrelu, 
    ...
    cubic, 
    gaussian, 
    sine, : good for everything(mostly)
    tanh_square, 
    mod_sigmoid, 
    quartic, 
    square_quartic, 
    ...
    scaled_cubic, 
    sine_offset,
    sift,: img feature detection
    fast,: img feature detection
    gabor,: img feature detection
    laplacian,: img feature detection
    cany,: img feature detection
    sobel: img feature detection
...
def load_model(model_name,
   ...
   lists: W(list[num]), activation_potentiation, DataFrame of the model
    ...
    try:
        ...
        print(Fore.RED + "ERROR: Model Path error. accaptable form: 'C:/Users/hasancanbeydili/Desktop/denemePLAN/' from: load_model" + Style.RESET_ALL)
