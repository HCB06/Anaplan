...
def learner(x_train, y_train, x_test=None, y_test=None, strategy='accuracy', big_data_mode=False, patience=None, depth=None, early_shifting=False, early_stop=False, loss='categorical_crossentropy', show_history=False, interval=33.33, target_acc=2, target_loss=-1, except_this=None, only_this=None):
    ...
    for i in range(depth):
        ...
        if show_history == True:
            ...
            ax[2].set_title('Activations Over Depth')
            artist3.append(art3)
