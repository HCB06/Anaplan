...
def learner(x_train, y_train, x_test=None, y_test=None, strategy='loss', depth=None, early_stop=False, loss='categorical_crossentropy', show_history=False, interval=33.33, target_acc=None, target_loss=None, except_this=None, only_this=None):
    ...
    Args:
        ...
        strategy (str): Learning strategy. Minimizing test loss or maximizing test accuracy ?: ('accuracy' or 'loss') Default is 'loss'
            ...
            if strategy == 'accuracy' and acc >= best_acc or strategy == 'loss' and test_loss <= best_loss:
                ...
                if target_acc is not None  or target_loss is not None:
                    ...
                    if strategy == 'accuracy' and best_acc >= target_acc  or strategy == 'loss' and best_loss <= target_loss:
                        ...
                        return best_weights, None, best_acc, final_activations
