...
def learner(x_train, y_train, x_test=None, y_test=None, strategy='accuracy', big_data_mode=False, patience=None, depth=None, early_shifting=False, early_stop=False, loss='categorical_crossentropy', show_history=False, interval=33.33, target_acc=None, target_loss=None, except_this=None, only_this=None):
    ...
    if strategy == 'adaptive_accuraacy':
    ...
    for i in range(depth):
        ...
        if adaptive == 'on' and strategy == 'accuracy' and i + 1 >= patience:
        ...
        elif adaptive == 'on' and strategy == 'loss' and best_loss <= patience:
