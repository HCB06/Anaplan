...
Args:
    ...
    activation_add_prob (float, optional): The probability of adding a new activation function to the genome. 
        Must be in the range [0, 1]. Default is 0.9.
    
    activation_delete_prob (float, optional): The probability of deleting an existing activation function 
        from the genome. Must be in the range [0, 1]. Default is 0.1.
    
    activation_change_prob (float, optional): The probability of changing an activation function in the genome. 
