...
from pyerualjetwork import plan as pn
...
"""
x_train = data_operations.normalization(x_train)         If you have more than 16 GB of RAM, uncomment this line and remove the normalization process above.
