...
__version__ = "2.3" 
__update__ = "*'New NEAT module 'planeat' included. Library architecture changed, documentation coming. For more details: https://github.com/HCB06/Anaplan/blob/main/Welcome_to_Anaplan/ANAPLAN_USER_MANUEL_AND_LEGAL_INFORMATION(EN).pdf."
